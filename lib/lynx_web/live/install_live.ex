    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
      <div class="max-w-md w-full space-y-8">
        <div class="text-center">
          ...
          <h2 class="mt-6 text-3xl font-bold text-gray-900">Setup Lynx</h2>
          <p class="mt-2 text-sm text-gray-500">Configure your Terraform backend</p>
        </div>

        <.card>
          <p :if={@error} class="mb-4 text-sm text-red-600 bg-red-50 rounded-lg px-4 py-3">{@error}</p>
